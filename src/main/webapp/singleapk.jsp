...
%>
<%
    TblApksBeans singleApp = apk.selectById(Integer.parseInt(request.getParameter("id")));
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <meta name="Description" content="<%= singleApp.getDescription()%>"/>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="entity_wrapper">
                                                        <div class="entity_title">
                                                            <h1><a href="<%= singleApp.getLink()%><"><%= singleApp.getName()%></a></h1>
                                                        </div>
                                                        <div class="entity_meta"><a href="<%= singleApp.getLink()%>" target="_blank"><%= singleApp.getDateTime()%></a>, by: <a href="#" target="_self">Admin</a>
                                                        </div>
                                                        ...
                                                        <div class="entity_content">
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-6">
                                                                    <div class="media">
                                                                        <img class="img-responsive" src="<%= singleApp.getImg()%>?tr=w-312,h-312" alt="<%= singleApp.getName()%>">
                                                                    </div>
                                                                    <div class="media_social">
                                                                        <a  href="<%= singleApp.getLink()%>" class="btn btn-success btn-lg">
                                                                            <b>Download</b>
                                                                        </a>
                                                        ...
                                                        <div class="entity_social">
                                                            <span class="blank"><i class="fa fa-share-alt"></i>424 <a href="#">Shares</a> </span>
                                                        ...
                                                        <div class="media">
                                                            <div class="media-left">
                                                                <a href="#">
                                                                    <img alt="64x64" class="media-object" data-src="assets/img/reader_img3.jpg" src="assets/img/reader_img3.jpg" data-holder-rendered="true">
                                                                </a>
                                                            </div>
                                                                    ...
                                                                    <div class="media">
                                                                        ...
                                                                        <div class="media-body">
                                                                            ...
                                                                            <a href="single.html" target="_self"><h3 class="media-heading">Fully new look slim handset
                                                                                    like</h3></a>
                                                                            <span class="media-date"><a href="#">10Aug- 2016</a>, by: <a href="#">Eric joan</a></span>
                                                                            <div class="media_social">
                                                                                <span><a href="#"><i class="fa fa-share-alt"></i>424</a> Shares</span>
                                                                                <span><a href="#"><i class="fa fa-comments-o"></i>4</a> Comments</span>
                                                                            </div>
